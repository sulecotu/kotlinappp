...
class ProfilPostListRecylerAdapter(var context:Context, var tumGonderiler:ArrayList<UserPosts>):RecyclerView.Adapter<ProfilPostListRecylerAdapter.MyViewHolder>() {
